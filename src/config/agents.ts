...
{"analysis":"one concise sentence describing the photo in French","suggestions":["improvement 1 in French","improvement 2 in French","improvement 3 in French"]}`,
    ...
    suggestions: [
      { label: "Eclaircir la piece", prompt: "Enhance interior lighting to look natural and warm, remove harsh shadows, brighten dark corners while keeping a realistic professional look", icon: Sun },
      ...
      { label: "Retirer elements parasites", prompt: "Remove all unwanted objects: electrical wires, utility poles, trash bins, parked cars, street clutter. Keep the building and landscape clean", icon: Trash2 },
      { label: "Raviver la vegetation", prompt: "Make the grass and garden lush, vibrant green. Remove dead or dry patches. Enhance trees and hedges to look healthy and maintained", icon: Leaf },
      { label: "Mise en scene virtuelle", prompt: "Add tasteful virtual furniture staging to this empty room: modern neutral-toned sofa, coffee table, plants, soft rug. Photorealistic, high-end interior design style", icon: Sofa },
      { label: "Nettoyer la facade", prompt: "Clean the building facade: remove stains, graffiti, moss, weathering marks, dirt. Make it look freshly maintained", icon: PaintBucket },
      { label: "Retirer cables electriques", prompt: "Remove all electrical wires, cables, and utility poles from the image. Clean sky and facade", icon: Zap },
...
{"analysis":"one concise sentence describing the photo in French","suggestions":["improvement 1 in French","improvement 2 in French","improvement 3 in French"]}`,
    ...
    suggestions: [
      ...
      { label: "Flou d'arriere-plan", prompt: "Apply professional DSLR-quality bokeh blur to background. Keep subject perfectly sharp with smooth falloff. Cinematic depth of field", icon: Aperture },
      { label: "Lumiere heure doree", prompt: "Apply warm golden hour lighting effect: soft orange/yellow sun rays, warm skin tones, golden highlights. Cinematic and dreamy", icon: Sunset },
      { label: "Color grading cinematique", prompt: "Apply cinematic film color grade: slightly lifted blacks, warm highlights, cool shadows (orange & teal split toning), high contrast. Hollywood look", icon: Film },
      { label: "Nettoyer l'arriere-plan", prompt: "Remove all unwanted objects, people, and distracting elements from the background. Keep the subject untouched. Clean, minimal background", icon: Eraser },
...
{"analysis":"one concise sentence describing the photo in French","suggestions":["improvement 1 in French","improvement 2 in French","improvement 3 in French"]}`,
    ...
    suggestions: [
      ...
      { label: "Retouche usure legere", prompt: "Minimize visible signs of light wear: pilling, slight fading, minor fabric damage. Keep it realistic but improved", icon: Sparkles },
    ],
  },
...
{"analysis":"one concise sentence describing the photo in French","suggestions":["improvement 1 in French","improvement 2 in French","improvement 3 in French"]}`,
    ...
    suggestions: [
      ...
      { label: "Ombre portee realiste", prompt: "Add a soft, realistic drop shadow under the product. Natural studio lighting effect. Professional e-commerce standard", icon: Lightbulb },
      { label: "Eclairage produit premium", prompt: "Enhance product lighting to look premium: bright, sharp, and desirable. Highlight textures and materials as if shot in a professional studio", icon: Sparkles },
      { label: "Cadrage centre uniforme", prompt: "Center the product perfectly with equal margins on all sides. Square format, product fills 70-80% of the frame. Professional e-commerce standard", icon: Crop },
      { label: "Retirer etiquettes prix", prompt: "Remove price tags, stickers, labels, barcodes from the product. Clean, tag-free product presentation", icon: Tag },
      { label: "Mise en scene lifestyle", prompt: "Place the product in a minimal, premium lifestyle context relevant to its category. Keep product sharp in foreground, soft contextual background", icon: Box },
    ],
  },
};
