...
export const PLANS: readonly Plan[] = [
  ...
  },
  {
    id: "pro",
    name: "Pro",
    tagline: "Pour les indépendants et petites structures",
    creditsPerMonth: 150,
    monthlyPriceEurCents: 4900,
    annualPriceEurCents: 47900,
    stripePriceEnvKeyMonthly: "STRIPE_PRICE_PRO_MONTHLY",
    stripePriceEnvKeyAnnual: "STRIPE_PRICE_PRO_ANNUAL",
    accentColor: "#E1306C",
    highlighted: true,
    features: [
      "150 retouches IA par mois",
      "Tout Starter inclus",
