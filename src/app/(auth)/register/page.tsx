      ...
      <div className="bg-surface rounded-2xl shadow-md p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 mt-2">
            Créez votre compte — {FREE_SIGNUP_CREDITS} crédits offerts
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              maxLength={100}
              autoComplete="name"
              className="w-full border border-white/10 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-brand-600 text-white rounded-xl py-3 font-semibold hover:bg-brand-700 transition-colors disabled:opacity-50"
          >
