...
export const metadata: Metadata = {
  ...
  description: "Transformez vos photos en aimants à clients en quelques secondes. Jusqu'à +61% de vues sur vos annonces, +40% de réservations Airbnb. 5 photos offertes sans CB.",
