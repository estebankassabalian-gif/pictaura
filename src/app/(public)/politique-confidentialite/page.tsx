  ...
  return (
    <div className="min-h-screen bg-cream text-ink">
      <div className="max-w-3xl mx-auto px-4 py-16">
        <Link href="/" className="text-accent font-semibold text-sm hover:underline mb-8 inline-block">
          ← Retour à l'accueil
        </Link>

        <h1 className="text-4xl md:text-5xl font-display tracking-tight text-ink mb-3">Politique de Confidentialité</h1>
        <p className="text-ink-muted text-sm mb-10">Dernière mise à jour : mars 2025</p>

        <div className="prose max-w-none space-y-8">

          <section>
            <h2 className="text-xl font-display text-ink mb-3">1. Responsable du traitement</h2>
            <p className="text-ink-muted">
              Esteban Kassabalian, éditeur de Pictaura (pictaura.app).
              Contact DPO : <a href="mailto:contact@pictaura.app" className="text-accent font-semibold hover:underline">contact@pictaura.app</a>
            </p>
          </section>

          <section>
            <h2 className="text-xl font-display text-ink mb-3">2. Données collectées</h2>
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">3. Finalités du traitement</h2>
            <ul className="text-ink-muted space-y-2 list-disc list-inside">
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">4. Base légale</h2>
            <p className="text-ink-muted">
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">5. Durée de conservation</h2>
            <ul className="text-ink-muted space-y-2 list-disc list-inside">
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">6. Sous-traitants</h2>
            <ul className="text-ink-muted space-y-2 list-disc list-inside">
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">7. Vos droits (RGPD)</h2>
            <p className="text-ink-muted">Conformément au RGPD, vous disposez des droits suivants :</p>
            <ul className="text-ink-muted space-y-2 list-disc list-inside mt-2">
            ...
            <p className="text-ink-muted mt-3">
              Pour exercer vos droits : <a href="mailto:contact@pictaura.app" className="text-accent font-semibold hover:underline">contact@pictaura.app</a>.
              Vous pouvez également introduire une réclamation auprès de la <a href="https://www.cnil.fr" target="_blank" rel="noopener" className="text-accent font-semibold hover:underline">CNIL</a>.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-display text-ink mb-3">8. Cookies</h2>
            <p className="text-ink-muted">
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">9. Sécurité</h2>
            <p className="text-ink-muted">
