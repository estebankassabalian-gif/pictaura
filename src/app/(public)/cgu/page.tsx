  ...
  return (
    <div className="min-h-screen bg-cream text-ink">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <h1 className="text-4xl md:text-5xl font-display tracking-tight text-ink mb-3">Conditions Générales d'Utilisation</h1>
        <p className="text-ink-muted text-sm mb-10">Dernière mise à jour : mars 2025</p>

        <div className="prose max-w-none space-y-8">

          <section>
            <h2 className="text-xl font-display text-ink mb-3">1. Présentation du service</h2>
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">2. Acceptation des CGU</h2>
            <p className="text-ink-muted">
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">3. Compte utilisateur</h2>
            <p className="text-ink-muted">
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">4. Crédits et paiements</h2>
            <p className="text-ink-muted">
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">5. Photos et contenus</h2>
            <p className="text-ink-muted">
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">6. Disponibilité du service</h2>
            <p className="text-ink-muted">
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">7. Limitation de responsabilité</h2>
            <p className="text-ink-muted">
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">8. Résiliation</h2>
            <p className="text-ink-muted">
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">9. Droit applicable</h2>
            <p className="text-ink-muted">
          ...
          <section>
            <h2 className="text-xl font-display text-ink mb-3">10. Contact</h2>
            <p className="text-ink-muted">
              Pour toute question relative aux CGU : <a href="mailto:contact@pictaura.app" className="text-accent font-semibold hover:underline">contact@pictaura.app</a>
            </p>
          </section>
