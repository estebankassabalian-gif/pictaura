    ...
    offers: {
      ...
      offers: [
        ...
        },
        {
          ...
          price: "5",
          priceCurrency: "EUR",
          description: "20 crédits — 1 crédit = 1 photo optimisée",
        },
        {
          "@type": "Offer",
          name: "Pack Pro",
  ...
  const schema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui, Pictaura offre 5 crédits gratuits à l'inscription, sans carte bancaire requise. 1 crédit = 1 photo traitée. Ensuite, des packs de crédits sont disponibles à partir de 5€ pour 20 crédits.",
        },
      },
      {
        "@type": "Question",
